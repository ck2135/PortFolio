  ...
  return (
    <Container id="projects">
      <Wrapper>
        ...
        <Desc>
          I have worked on a web development of projects. From web apps with static,Responsive web app and Dynamic. Here are some of my projects.
        </Desc>
        <ToggleButtonGroup >
          {toggle === 'all' ?
          ...
          {toggle === 'android app' ?
            ...
            :
            <ToggleButton value="android app" onClick={() => setToggle('html & css')}>HTML & CSS</ToggleButton>
          }
          <Divider />
